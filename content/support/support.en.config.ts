...
export const supportEnConfig: SupportPageConfig = {
  seo: {
  ...
  categories: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: [
            "Make sure the network environment works normally.",
            "Check the URL you copied from online video address is right.",
            "Make sure the video is not protected and the website of this video is supported by our software.",
            "Click the menu, go to Help > Open Log Folder, then it will automatically open the log file. Please compress the Log folder and send to us.",
          ],
        },
        {
