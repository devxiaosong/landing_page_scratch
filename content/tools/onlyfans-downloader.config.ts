...
export const onlyfansDownloaderConfig: ToolLandingConfig = {
  ...
  guide: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Sign in to the OnlyFans website using your subscription account, and play the video you want to download.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes, you can have 1 free download to test the app after you install MassLoader OnlyFans Video on your computer.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, MassLoader OnlyFans Downloader is legal for only personal use, and it's secured with a built-in browser without storing use data.",
      },
      {
        question: "Q4. Can I watch downloaded OnlyFans videos on other devices?",
        answer:
          "Yes, you can download OnlyFans videos in MP4 or MKV formats, which can be playable on most devices (phones, PCs, tablets).",
      },
    ],
  },
  cta: {
    ...
    title:
      "Download Your Favorite Videos with MassLoader OnlyFans Downloader Now!",
    windowsDownloadUrl: "/download/?product=massloader.exe",
    macDownloadUrl: "/download/?product=massloader.dmg",
  },
};
