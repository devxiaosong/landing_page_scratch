...
export const onlyfansDownloaderDeConfig: ToolLandingConfig = {
  toolId: "onlyfans-downloader",
  canonicalPath: "/de",
  seo: {
    ...
    primaryKeyword: "OnlyFans Video Downloader",
    ogImage: "/images/onlyfans-downloader/onlyfans-downloader.png",
    ogImageAlt: "MassLoader OnlyFans Video Downloader",
    alternates: {
  ...
  jsonLd: {
    ...
    aggregateRating: { ratingValue: "4.9", ratingCount: "2100" },
  },
  hero: {
    brandTag: "MassLoader",
  ...
  pricing: {
    ...
    features: [
      ...
      {
        name: "Videos/Audio von 10.000+ Seiten herunterladen",
        free: "3 Dateien",
        standard: true,
        pro: true,
      },
      {
        name: "Musik von Apple Music, Spotify, Amazon Music, Deezer und TIDAL konvertieren",
        free: "1 Datei",
        standard: true,
        pro: true,
      },
      {
        name: "Dateien in MP4, MP3 und Originalformat konvertieren",
        free: "1/3 Länge",
        standard: true,
        pro: true,
      },
      {
        name: "Playlist, Album, Künstler und mehr herunterladen",
        free: "1 Datei",
        standard: true,
        pro: true,
      },
      {
        name: "Medien in 20+ Ausgabeformate konvertieren",
        free: null,
        standard: true,
        pro: true,
        isLastInGroup: true,
  ...
  testimonials: {
    ...
    testimonials: [
      {
        quote:
          "Als Social-Media-Marketer ist dies definitiv eines der zuverlässigsten und professionellsten Tools, das ich seit 2 Jahren verwende und nie mehr missen möchte. Danke an das professionelle MassLoader-Team für dieses Erlebnis.",
        name: "Arash Ashouri",
        avatar: "/images/onlyfans-downloader/user1.svg",
      },
      {
        quote:
          "Ich nutze die App seit einem Jahr. Alles funktioniert einwandfrei und der Service ist einfach der beste. Wenn ich ein Problem habe, ist das Team immer da, um zu helfen! 10/10!",
        name: "Denis Hoshikawa",
        avatar: "/images/onlyfans-downloader/user2.svg",
      },
      {
        quote:
          "Ich habe die MassLoader-Lifetime-Lizenz gekauft und bin sehr zufrieden. Ich spare Zeit beim Aufzeichnen von Videos und kann den Ton meiner Lieblingslieder speichern. Ich empfehle diese App jedem!",
    ...
    faqs: [
      {
        ...
        answer:
          "Ja, Sie können nach der Installation von MassLoader OnlyFans Video auf Ihrem Computer 1 kostenlosen Download testen.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Ja, der MassLoader OnlyFans Downloader ist nur für den persönlichen Gebrauch legal und mit einem integrierten Browser gesichert, der keine Nutzerdaten speichert.",
      },
      {
        question: "F4. Kann ich heruntergeladene OnlyFans-Videos auf anderen Geräten ansehen?",
        answer:
          "Ja, Sie können OnlyFans-Videos in MP4- oder MKV-Formaten herunterladen, die auf den meisten Geräten (Smartphones, PCs, Tablets) abspielbar sind.",
      },
    ],
  },
  cta: {
    ...
    title:
      "Laden Sie jetzt Ihre Lieblingsvideos mit dem MassLoader OnlyFans Downloader herunter!",
    windowsDownloadUrl: "/download/?product=massloader.exe",
    macDownloadUrl: "/download/?product=massloader.dmg",
  },
};
